...
/// <summary>
/// Генерация кандидатов board_token из названия компании.
///
/// Работает потому, что слаг у большинства компаний — это просто имя в нижнем регистре
/// (finom, nebius, jetbrains). Список намеренно КОРОТКИЙ: перебирать словарь по чужому API
/// нельзя ни этически, ни практически.
/// </summary>
public static class SlugGuesser
{
    ...
    /// <summary>Извлечь слаг из ссылки на борд или карьерную страницу Greenhouse.</summary>
    public static string? ExtractFromUrl(string url)
    {
        ...
        // Формы: boards.greenhouse.io/{slug}, job-boards.greenhouse.io/{slug},
